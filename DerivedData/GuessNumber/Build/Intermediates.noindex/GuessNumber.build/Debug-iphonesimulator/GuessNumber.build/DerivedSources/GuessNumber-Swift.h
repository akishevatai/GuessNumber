...
#ifndef GUESSNUMBER_SWIFT_H
#define GUESSNUMBER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GuessNumber",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11GuessNumber11AppDelegate")
...
SWIFT_CLASS("_TtC11GuessNumber18EasyViewController")
@interface EasyViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified rangeLbl;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified numGuessesLbl;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified showLivesLabel;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC11GuessNumber13SceneDelegate")
...
SWIFT_CLASS("_TtC11GuessNumber14ViewController")
